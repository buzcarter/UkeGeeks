...
var parts=_textToParts(nL);var n=_getInstrument(text);var t=_getTuning(text);return new ukeGeeks.data.instrument(_getKey(n,t),n,t,_partsToChords(parts));};};ukeGeeks.transpose=new function(){var re=/^([A-G][#b]?)(.*)/;var tones={'A':0,'A#':1,'Bb':1,'B':2,'C':3,'C#':4,'Db':4,'D':5,'D#':6,'Eb':6,'E':7,'F':8,'F#':9,'Gb':9,'G':10,'G#':11,'Ab':11};this.shift=function(name,steps){var t=getTone(name);if(t==null){return null;}
...
return newChords;};};;ukeGeeks.definitions.addInstrument("\
...
return ctx;};};ukeGeeks.chordBrush=function(){var publics={};publics.init=function(){};publics.plot=function(chordBox,chord,fretBox,fontSettings,colorSettings){var ctx=ukeGeeks.canvasTools.addCanvas(chordBox,fretBox.width,fretBox.height);if(ctx==null){return;}
