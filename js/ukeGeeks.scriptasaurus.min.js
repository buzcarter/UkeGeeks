...
;ukeGeeks.overlapFixer=(function(){var _publics={};var checkOverlap=function(a,b){if((b.left>a.right)||(b.right<a.left)){return false;}
if((b.left>a.left)&&(b.left<a.right)){return true;}
if((b.right>a.left)&&(b.right<a.right)){return true;}
return false;};var getBox=function(ele){var box={width:getWidth(ele),left:getLeftOffset(ele),right:0};var em=ele.getElementsByTagName('em')[0];if(em){var emWidth=getWidth(em);if(emWidth>box.width){box.width=emWidth+2;}}
box.right=box.left+box.width;return box;};var getWidth=function(ele){if(typeof ele.clip!=="undefined"){return ele.clip.width;}
return(ele.style.pixelWidth)?ele.style.pixelWidth:ele.offsetWidth;};var getLeftOffset=function(ele){var left=0;while(ele&&!isNaN(ele.offsetLeft)){left+=ele.offsetLeft-ele.scrollLeft;ele=ele.offsetParent;}
return left;};var checkChords=function(codeA,codeB){var strongA=codeA.getElementsByTagName('strong')[0];var strongB=codeB.getElementsByTagName('strong')[0];if(!strongA||!strongB){return;}
